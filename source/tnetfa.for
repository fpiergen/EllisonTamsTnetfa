...
C      INTEGER CURVE,TPRINT,CTYPE,ATYPE,BTYPE,BARY,UNITS
      INTEGER CTYBLD
...
C	CAP=JOULES/DEG. C, TIME=SEC
      READ (1,*, iostat=stat) MODE,UNITS,ICSE
C10    READ (1,780, iostat=stat) (TITLE1(I),I=1,8)
      IF (stat /= 0) CALL EXIT
...
250   READ (1, *, iostat=stat)ISINA,ISTRA
      IF (stat /= 0) CALL EXIT
